      ...
      <div className="grid auto-rows-max items-start gap-4 md:gap-12 lg:col-span-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Key metrics for your Scrum project.
            </CardDescription>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage your project tasks with the Kanban board.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid lg:col-span-1 gap-4 md:gap-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Key performance metrics for your project.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Linechart />
          ...
          <CardContent>
            <div className="grid gap-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-md text-muted-foreground ml-auto"><ClockIcon size={'1rem'}/> 2d ago</div>
              </div>
            </div>
          </CardContent>
        </Card>
